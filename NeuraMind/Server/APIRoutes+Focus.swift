...
extension APIServer {
    ...
    private static func mapFocusState(_ state: NeuraMindFocusState) -> FocusStateItem {
        FocusStateItem(
            id: state.id,
            task: state.task,
    ...
    private static func mapFocusBlock(_ block: NeuraMindFocusBlock) -> FocusBlockItem {
        FocusBlockItem(
            id: block.id,
            task: block.task,
