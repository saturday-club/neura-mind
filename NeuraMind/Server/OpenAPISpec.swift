...
/// Static OpenAPI 3.1 specification for the NeuraMind API.
...
enum OpenAPISpec {
    static let json = """
    {
      ...
      "info": {
        "title": "NeuraMind API",
        "description": "Search and browse your recent screen activity. NeuraMind continuously captures and summarizes what you see on screen, and this API lets you search summaries, list activity, and retrieve structured data from your captures.",
        "version": "0.1.0",
        "contact": {
          "name": "NeuraMind"
        },
      ...
      "servers": [
        {
          ...
          "description": "Local NeuraMind instance"
        }
      ],
      "paths": {
        "/v1/search": {
        ...
        "/health": {
          "get": {
            ...
            "description": "Returns the current status of the NeuraMind API server and basic database statistics.",
            "responses": {
              "200": {
